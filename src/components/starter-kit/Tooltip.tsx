...
const styles = tv({
  base: "group bg-slate-700 border border-slate-800 shadow-[inset_0_1px_0_0_var(--color-gray-600)] text-white text-sm rounded-lg drop-shadow-lg will-change-transform px-3 py-1",
  variants: {
    isEntering: {
